  ...
  return (
    <div className="home-page">
      ...
      <section className="news-section">
        ...
        {/* Instagram Carousel */}
        <div className="ig-carousel-outer">
          <button className="carousel-arrow carousel-arrow-prev" onClick={handlePrev} aria-label="上一則">&#10094;</button>
          ...
          <button className="carousel-arrow carousel-arrow-next" onClick={handleNext} aria-label="下一則">&#10095;</button>
        </div>
